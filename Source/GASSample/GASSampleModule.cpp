...
/*
* implements the XEnergyCollect module
*/
// class FXEnergyCollectModule : public IModuleInterface
// {
// public:
// 	//~ IModuleInterface interface(definition as a prototype)
...
//IMPLEMENT_MODULE(FXEnergyCollectModule, XEnergyCollect);
