...
#include "MassEntitySpacedGridSpawnPointsGenerator_Mc.generated.h"

/**
 * Describes the SpawnPoints Generator when we want to spawn directly on spaced grid location.
 */
UCLASS(BlueprintType, meta=(DisplayName="SpacedGrid SpawnPoints Generator Mc"))
class MASSCOMPANION_API UMassEntitySpacedGridSpawnPointsGenerator_Mc : public UMassEntitySpawnDataGeneratorBase
{
	GENERATED_BODY()
public:
